...
-- 人気配信者一覧（tw-clipの「登録ユーザー一覧」相当）
-- クリップの合計視聴回数が多い順に配信者を返す
create or replace function get_top_broadcasters(broadcaster_limit int default 20)
returns table(streamer text, total_views bigint, clip_count bigint) as $$
  select streamer,
